...
class SelfAttention(Layer):
    ...
    def build(self, input_shape):
        ...
        self.kernel_f = self.add_weight(shape=kernel_shape_f_g, initializer='glorot_uniform',name='kernel_f', trainable=True)
        self.kernel_g = self.add_weight(shape=kernel_shape_f_g,initializer='glorot_uniform',name='kernel_g',trainable=True)
        self.kernel_h = self.add_weight(shape=kernel_shape_h,initializer='glorot_uniform',name='kernel_h',trainable=True)
    ...
    def call(self, x):
        ...
        beta = K.softmax(s, axis=-1)  # ATTENTION MAP - Need to visualize for bonus mark
